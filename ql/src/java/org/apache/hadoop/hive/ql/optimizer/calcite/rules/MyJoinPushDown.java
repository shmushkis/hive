...
public class MyJoinPushDown extends RelOptRule {
  ...
  public void onMatch(RelOptRuleCall call) {
    LOG.info("MyJoinPushDown has been called");
    ...
    Join newHiveJoin = join.copy(join.getTraitSet(), join.getCondition(), input1, input2, join.getJoinType(),join.isSemiJoinDone());
    JdbcJoin newJdbcJoin = (JdbcJoin) new JdbcJoinRule(JdbcConvention.JETHRO_DEFAULT_CONVENTION).convert(newHiveJoin);
